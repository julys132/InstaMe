...
export default function RegisterScreen() {
  ...
  useEffect(() => {
    if (Platform.OS === "web" && !googleWebConfigured) {
      console.warn("Missing EXPO_PUBLIC_GOOGLE_WEB_CLIENT_ID; Google signup is disabled on web.");
    }
  }, [googleWebConfigured]);
      ...
      >
        ...
        >
          ...
          <Animated.View entering={FadeIn.duration(800)} style={styles.brandSection}>
            <Text style={styles.brandLabel}>Join Chicoo</Text>
...
const styles = StyleSheet.create({
  ...
  brandSection: { marginBottom: 32, gap: 2 },
  brandLabel: {
