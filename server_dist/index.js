...
var INSTAME_TRANSFORM_COST = Number.parseInt(process.env.INSTAME_TRANSFORM_COST || "5", 10);
...
async function registerRoutes(app2) {
  ...
  app2.post("/api/instame/transform", authMiddleware, async (req, res) => {
    ...
    const transformCost = Number.isInteger(INSTAME_TRANSFORM_COST) && INSTAME_TRANSFORM_COST > 0 ? INSTAME_TRANSFORM_COST : 5;
