...
const PACKS: Array<{ id: string; count: GridPipelineImageCount }> = [
  ...
  { id: "Monaco Night Drive", count: 6 },
  { id: "Paris Hotel Morning", count: 6 },
  { id: "Milan Street Editorial", count: 6 },
  { id: "Ski Chalet Luxe", count: 6 },
  { id: "Gallery Date Muse", count: 6 },
  { id: "Champagne Brunch Club", count: 6 },
  { id: "Balletcore Soft Glam", count: 6 },
  { id: "Rooftop Golden Hour", count: 6 },
  { id: "Bridal Weekend Glow", count: 6 },
  { id: "CEO Airport Uniform", count: 6 },
